...
doctorRouter.put("/accept/:id", auth, doctorController.accept);

doctorRouter.put("/reject/:id", auth, doctorController.reject);

doctorRouter.get("/getapproveddoctors", auth, doctorController.getapproveddoctors);
